...
Stack = (function (_Array) {_inherits(Stack, _Array);function Stack() {_classCallCheck(this, Stack);_get(Object.getPrototypeOf(Stack.prototype), "constructor", this).apply(this, arguments);}_createClass(Stack, [{ key: "clear", value: 
    ...
    function clear() {
      while (this.length > 0) this.pop();} }, { key: "top", get: function get() {return this.length > 0 ? this[this.length - 1] : undefined;} }]);return Stack;})(Array);exports["default"] = Stack;module.exports = exports["default"];
