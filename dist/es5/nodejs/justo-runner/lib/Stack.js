...
Stack = function (_Array) {_inherits(Stack, _Array);
  ...
  function Stack() {_classCallCheck(this, Stack);var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Stack).call(this));
    ...
    Object.defineProperty(_this, "clear", { enumerable: true, value: function value() {
        while (_this.length > 0) {_this.pop();}} });return _this;}return Stack;}(Array);exports.default = Stack;
