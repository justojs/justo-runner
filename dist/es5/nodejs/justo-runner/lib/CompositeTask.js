...
CompositeTask = (function (_Task) {_inherits(CompositeTask, _Task);function CompositeTask() {_classCallCheck(this, CompositeTask);_get(Object.getPrototypeOf(CompositeTask.prototype), "constructor", this).apply(this, arguments);}_createClass(CompositeTask, [{ key: "isSimple", value: 



    function isSimple() {
      return false;} }]);return CompositeTask;})(_Task3["default"]);exports["default"] = CompositeTask;module.exports = exports["default"];
