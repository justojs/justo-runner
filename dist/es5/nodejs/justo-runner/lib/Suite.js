...
Suite = function (_CompositeTask) {_inherits(Suite, _CompositeTask);
  ...
  function Suite(opts) {_classCallCheck(this, Suite);var _this = _possibleConstructorReturn(this, (Suite.__proto__ || Object.getPrototypeOf(Suite)).call(this,
    opts));
    ...
    Object.defineProperty(_this, "only", { value: !!opts.only });return _this;
  }_createClass(Suite, [{ key: "hasParent", value: function hasParent()
    ...
    wrapper) {
      ...
      if (task instanceof _Initializer2.default) {
        ...
        this.testInitializers.push(wrapper);
      } else if (task instanceof _Finalizer2.default) {
        if (task.isOfSuite()) this.finalizers.push(wrapper);else
        if (task.isOfForEach()) this._forEachFinalizers.push(wrapper);else
        this.testFinalizers.push(wrapper);
      } else {
        this.tasks.push(wrapper);
        task._parent = this;
      }
    } }, { key: "getSpecificInitializersOf", value: function getSpecificInitializersOf(
    ...
    name) {
      ...
      return inits;
    } }, { key: "getSpecificFinalizersOf", value: function getSpecificFinalizersOf(
