...
"./CompositeTask");var _CompositeTask3 = _interopRequireDefault(_CompositeTask2);var _Initializer = require(
"./Initializer");var _Initializer2 = _interopRequireDefault(_Initializer);var _Finalizer = require(
"./Finalizer");var _Finalizer2 = _interopRequireDefault(_Finalizer);var 
...
Suite = (function (_CompositeTask) {_inherits(Suite, _CompositeTask);
  ...
  function Suite(opts) {_classCallCheck(this, Suite);
    _get(Object.getPrototypeOf(Suite.prototype), "constructor", this).call(this, opts);
    ...
    Object.defineProperty(this, "_only", { value: !!opts.only });}_createClass(Suite, [{ key: "hasParent", value: 
    ...
    function hasParent() {
      return !!this._parent;} }, { key: "add", value: 
    ...
    function add(wrapper) {
        ...
        this.testFinalizers.push(wrapper);} else 
      {
        ...
        task._parent = this;}} }, { key: "getSpecificInitializersOf", value: 
    ...
    function getSpecificInitializersOf(name) {
      var inits;
      ...
      return inits;} }, { key: "getSpecificFinalizersOf", value: 
    ...
    function getSpecificFinalizersOf(name) {
      var fins;
      ...
      return fins;} }, { key: "parent", get: function get() {return this._parent;} }, { key: "only", get: function get() {var res;if (this._only) {res = true;} else {res = false;var _iteratorNormalCompletion3 = true;var _didIteratorError3 = false;var _iteratorError3 = undefined;try {for (var _iterator3 = this.tasks[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {var child = _step3.value;if (child.__task__.only) {res = true;break;}}} catch (err) {_didIteratorError3 = true;_iteratorError3 = err;} finally {try {if (!_iteratorNormalCompletion3 && _iterator3["return"]) {_iterator3["return"]();}} finally {if (_didIteratorError3) {throw _iteratorError3;}}}}return res;} }, { key: "fullyOnly", get: function get() {var onlys;onlys = 0;var _iteratorNormalCompletion4 = true;var _didIteratorError4 = false;var _iteratorError4 = undefined;try {for (var _iterator4 = this.tasks[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {var child = _step4.value;onlys += child.__task__.only ? 1 : 0;}} catch (err) {_didIteratorError4 = true;_iteratorError4 = err;} finally {try {if (!_iteratorNormalCompletion4 && _iterator4["return"]) {_iterator4["return"]();}} finally {if (_didIteratorError4) {throw _iteratorError4;}}}return onlys === 0;} }, { key: "hasOnly", get: function get() {} }, { key: "forEachInitializers", get: function get() {return (this.parent ? this.parent.forEachInitializers : []).concat(this._forEachInitializers);} }, { key: "forEachFinalizers", get: function get() {return (this.parent ? this.parent.forEachFinalizers : []).concat(this._forEachFinalizers);} }]);return Suite;})(_CompositeTask3["default"]);exports["default"] = Suite;module.exports = exports["default"];
