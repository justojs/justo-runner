...
TaskMacro = function (_CompositeTask) {_inherits(TaskMacro, _CompositeTask);
  ...
  function TaskMacro(opts, tasks) {_classCallCheck(this, TaskMacro);var _this = _possibleConstructorReturn(this, (TaskMacro.__proto__ || Object.getPrototypeOf(TaskMacro)).call(this,
  ...
  }_createClass(TaskMacro, [{ key: "add", value: function add(
    ...
    } }, { key: "length", get: function get() {return this.tasks.length;} }, { key: "synchronous", get: function get()
...

    {
      ...
      return res;
    } }]);return TaskMacro;}(_CompositeTask3.default);exports.default = TaskMacro;
