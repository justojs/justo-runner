...
RunError = (function (_Error) {_inherits(RunError, _Error);
  ...
  function RunError(item, error) {_classCallCheck(this, RunError);
    ...
    Object.defineProperty(this, "error", { value: error, enumerable: true });}return RunError;})(Error);exports["default"] = RunError;module.exports = exports["default"];
