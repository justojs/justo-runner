...
Task = (function (_Item) {_inherits(Task, _Item);
  ...
  function Task(opts) {_classCallCheck(this, Task);
    ...
    _get(Object.getPrototypeOf(Task.prototype), "constructor", this).call(this, opts);


    Object.defineProperty(this, "namespace", { value: opts.namespace || opts.ns, enumerable: true });}_createClass(Task, [{ key: "isSimple", value: 
    ...
    function isWorkflow() {
      throw new Error("Abstract method.");} }, { key: "ns", get: function get() {return this.namespace;} }, { key: "fullQualifiedName", get: function get() {return (this.namespace ? this.namespace + "." : "") + this.name;} }, { key: "fqn", get: function get() {return this.fullQualifiedName;} }]);return Task;})(_Item3["default"]);exports["default"] = Task;module.exports = exports["default"];
