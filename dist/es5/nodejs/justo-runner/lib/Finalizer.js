...
Finalizer = (function (_Operation) {_inherits(Finalizer, _Operation);function Finalizer() {_classCallCheck(this, Finalizer);_get(Object.getPrototypeOf(Finalizer.prototype), "constructor", this).apply(this, arguments);}_createClass(Finalizer, [{ key: "title", get: 
    ...
    function get() {
      ...
      return "fin(" + this.name + ")";} }]);return Finalizer;})(_Operation3["default"]);exports["default"] = Finalizer;module.exports = exports["default"];
