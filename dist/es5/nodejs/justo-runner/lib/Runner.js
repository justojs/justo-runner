...
var _justoTask = require("justo-task");
...
var Runner = (function () {
  ...
  _createClass(Runner, [{
    ...
    key: runSimpleTask,
    value: function value(task, opts, params) {
    ...
    key: runMacro,
    value: function value(macro, opts, params) {
      ...
      if (opts.ignore) {
        ...
        try {
          ...
          try {
            for (var _iterator = macro.tasks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              var t = _step.value;
              ...
              if (_task.task && _task.task instanceof _justoTask.SimpleTask) {
                this[runSimpleTask](_task.task, opts, pp);
              } else if (_task.macro && _task.macro instanceof _justoTask.Macro) {
                this[runMacro](_task.macro, opts, pp);
              } else {
                _task.apply(undefined, _toConsumableArray(pp));
              }
            }
          } catch (err) {
