...
Initializer = (function (_Operation) {_inherits(Initializer, _Operation);function Initializer() {_classCallCheck(this, Initializer);_get(Object.getPrototypeOf(Initializer.prototype), "constructor", this).apply(this, arguments);}_createClass(Initializer, [{ key: "title", get: 
    ...
    function get() {
      ...
      return "init(" + this.name + ")";} }]);return Initializer;})(_Operation3["default"]);exports["default"] = Initializer;module.exports = exports["default"];
