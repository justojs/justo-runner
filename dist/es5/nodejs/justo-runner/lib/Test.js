...
Test = (function (_CompositeTask) {_inherits(Test, _CompositeTask);
  ...
  function Test(opts, fn) {_classCallCheck(this, Test);

    _get(Object.getPrototypeOf(Test.prototype), "constructor", this).call(this, opts);


    Object.defineProperty(this, "fn", { value: fn, enumerable: true });
    Object.defineProperty(this, "_parent", { value: undefined, writable: true });
    Object.defineProperty(this, "only", { value: !!opts.only, enumerable: true });}_createClass(Test, [{ key: "parent", get: 


    function get() {
      return this._parent;} }, { key: "initializers", get: 
    ...
    function get() {
      ...
      return parent.forEachInitializers.concat(parent.getSpecificInitializersOf(this.name));} }, { key: "finalizers", get: 
    ...
    function get() {
      var parent = this._parent;
      return parent.forEachFinalizers.concat(parent.getSpecificFinalizersOf(this.name));} }]);return Test;})(_CompositeTask3["default"]);exports["default"] = Test;module.exports = exports["default"];
