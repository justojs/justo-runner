...
Test = function (_CompositeTask) {_inherits(Test, _CompositeTask);
  ...
  function Test(opts, fn) {_classCallCheck(this, Test);var _this = _possibleConstructorReturn(this, (Test.__proto__ || Object.getPrototypeOf(Test)).call(this,
    ...
    Object.defineProperty(_this, "params", { value: opts.params, writable: true, enumerable: true });return _this;
  }_createClass(Test, [{ key: "hasParams", value: function hasParams()
    ...
    {
      return !!this.params;
    } }, { key: "parent", get: function get() {return this._parent;} }, { key: "initializers", get: function get()
    ...
    } }, { key: "finalizers", get: function get()
    ...
    } }]);return Test;}(_CompositeTask3.default);exports.default = Test;
