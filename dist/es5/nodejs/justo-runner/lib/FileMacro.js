...
FileMacro = function (_CompositeTask) {_inherits(FileMacro, _CompositeTask);
  ...
  function FileMacro(opts, config) {_classCallCheck(this, FileMacro);var _this = _possibleConstructorReturn(this, (FileMacro.__proto__ || Object.getPrototypeOf(FileMacro)).call(this,
    ...
    Object.defineProperty(_this, "require", { value: config.require, enumerable: true });return _this;
  }return FileMacro;}(_CompositeTask3.default);exports.default = FileMacro;
