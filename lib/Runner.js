...
import {SimpleTask, Macro, Workflow} from "justo-task";
...
export default class Runner {
  ...
  [workflow](...args) {
    ...
    //(2) create task
    tsk = new Workflow(ns, name, opts, fn);
    ...
    wrapper = (opts, ...params) => {
      ...
      //(2) run task
      return this[runWorkflow](tsk, opts, params);
    };
  ...
  [defineMute](wrapper) {
    Object.defineProperty(wrapper, "mute", {
      value: (opts, ...params) => {
        if (typeof(opts) == "string") opts = {title: opts};
        wrapper(Object.assign({}, opts, {mute: true}), ...params);
      },
      enumerable: true
    });
  }
